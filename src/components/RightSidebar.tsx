            ...
            <div className="grid grid-cols-2 gap-2">
              {SHADOW_PRESETS.map((preset: ShadowPreset) => (
                <button
                  ...
                  className={`px-3 py-2 text-sm rounded-md transition-colors border-2 ${state.shadow === preset.value ? 'bg-indigo-600 border-indigo-500 text-white' : 'bg-gray-800 border-gray-700 hover:bg-gray-700'
                    }`}
                >
                  {preset.name}
                </button>
